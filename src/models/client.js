...
const createNewClient = (body) => {
    const sqlQuery = `  INSERT INTO client (name, phone, password, address, comment, fk_user_id)
                        VALUES ('${body.name}', '${body.phone}', '${body.password}', '${body.address}', '${body.comment}', '${body.fk_user_id}')`
